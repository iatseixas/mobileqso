const CACHE_NAME = 'qso-logbook-pwa-v2.6-11';
const APP_SHELL = [
  './',
  './index.html',
...
function patchIndex(html) {
  ...
  if (!html.includes('id="theme-coherence-runtime"')) tags.push('<script id="theme-coherence-runtime" src="./theme-coherence.js?v=2.6-7"></script>');
